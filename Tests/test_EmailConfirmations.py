...
class TestClass:
    ...
    def test_BasicUserEmailVerification(self, driver):
        ...
        verification_link = email_agent.get_verification_link_from_email(NewBasicUser.email, NewBasicUser.password, "Freewallet", "Verify")
    ...
    def test_GoogleUserEmailVerification(self, driver):
        ...
        verification_link = email_agent.get_verification_link_from_email(NewGoogleUser.email, NewGoogleUser.password, "Freewallet", "Verify")
        settingsPage.navigate_to_link(verification_link)
